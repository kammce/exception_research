...
extern "C"
{
  ...
  extern std::uint32_t __exceptional_functions_start;
  extern std::uint32_t __exceptional_functions_end;
                               ...
                               _uw return_address)
  {
    ...
    std::uint32_t* start = &__exceptional_functions_start;
    std::uint32_t* end = &__exceptional_functions_end;
